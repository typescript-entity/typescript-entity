...
export declare type Normalizer<T extends AttributeType, A extends AttributeConfigs> = (entity: Entity<A>, name: keyof A, value: any) => T;
export declare type Validator<T extends AttributeType, A extends AttributeConfigs> = (entity: Entity<A>, name: keyof A, value: T) => boolean;
...
export declare type AttributeType = string | string[] | number | number[] | boolean | boolean[];
